...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		{
		case VK_UP:
			translate_value = translate_value + 0.1f;
			break;
...
void display(void)
{
	...
	modelMatrix = translate(0.0f, 0.0f, translate_value + 1.0f);
	...
	modelMatrix = translate(0.0f, 0.0f, translate_value);
