...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	//Flag for tweaking smiley
	private int iSmileyTweakFlag = 0;
	...
	public void draw()
	{
		...
		GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER,vbo_texture[0]);
		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER,squareTexcoords.length*4,textureBuffer,GLES32.GL_DYNAMIC_DRAW);
		GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER,0);
