	...
	public void draw()
	{
		...
		if(doubleTap == 1)
		{
			if(singleTap == 1)
			{
				...
				light_position_White[2] = (float)(Math.cos(angleSphere) * 100.0f)-2.0f;
				light_position_White[0] = -0.3f;
			}
			else if(singleTap == 2)
			{
				light_position_White[0] = (float)(Math.sin(angleSphere) * 100.0f)-0.3f;
				light_position_White[2] = (float)(Math.cos(angleSphere) * 100.0f)-2.0f;
		...
		Matrix.translateM(modelMatrix,0,-0.3f,0.0f,-2.0f);
		...
		GLES32.glViewport(0,0,iWidth/4,iHeight/4);
		Draw_Sphere_1();
		GLES32.glViewport(iWidth/6,0,iWidth/4,iHeight/4);
		Draw_Sphere_2();
		GLES32.glViewport(iWidth/3,0,iWidth/4,iHeight/4);
		Draw_Sphere_3();
		GLES32.glViewport(iWidth/2,0,iWidth/4,iHeight/4);
		Draw_Sphere_4();
		GLES32.glViewport(iWidth/2 + iWidth/6,0,iWidth/4,iHeight/4);
		Draw_Sphere_5();
		GLES32.glViewport(iWidth/2 + iWidth/3,0,iWidth/4,iHeight/4);
		Draw_Sphere_6();
		GLES32.glViewport(0,iHeight/4,iWidth/4,iHeight/4);
		Draw_Sphere_7();
		GLES32.glViewport(iWidth/6,iHeight/4,iWidth/4,iHeight/4);
		Draw_Sphere_8();
		GLES32.glViewport(iWidth/3,iHeight/4,iWidth/4,iHeight/4);
		Draw_Sphere_9();
		GLES32.glViewport(iWidth/2,iHeight/4,iWidth/4,iHeight/4);
		Draw_Sphere_10();
		GLES32.glViewport(iWidth/2+iWidth/6,iHeight/4,iWidth/4,iHeight/4);
		Draw_Sphere_11();
		GLES32.glViewport(iWidth/2+iWidth/3,iHeight/4,iWidth/4,iHeight/4);
		Draw_Sphere_12();
		GLES32.glViewport(0,iHeight/2,iWidth/4,iHeight/4);
		Draw_Sphere_13();
		GLES32.glViewport(iWidth/6,iHeight/2,iWidth/4,iHeight/4);
		Draw_Sphere_14();
		GLES32.glViewport(iWidth/3,iHeight/2,iWidth/4,iHeight/4);
		Draw_Sphere_15();
		GLES32.glViewport(iWidth/2,iHeight/2,iWidth/4,iHeight/4);
		Draw_Sphere_16();
		GLES32.glViewport(iWidth/2+iWidth/6,iHeight/2,iWidth/4,iHeight/4);
		Draw_Sphere_17();
		GLES32.glViewport(iWidth/2+iWidth/3,iHeight/2,iWidth/4,iHeight/4);
		Draw_Sphere_18();
		GLES32.glViewport(0,iHeight/2+iHeight/4,iWidth/4,iHeight/4);
		Draw_Sphere_19();
		GLES32.glViewport(iWidth/6,iHeight/2+iHeight/4,iWidth/4,iHeight/4);
		Draw_Sphere_20();
		GLES32.glViewport(iWidth/3,iHeight/2+iHeight/4,iWidth/4,iHeight/4);
		Draw_Sphere_21();
		GLES32.glViewport(iWidth/2,iHeight/2+iHeight/4,iWidth/4,iHeight/4);
		Draw_Sphere_22();
		GLES32.glViewport(iWidth/2+iWidth/6,iHeight/2+iHeight/4,iWidth/4,iHeight/4);
		Draw_Sphere_23();
		GLES32.glViewport(iWidth/2+iWidth/3,iHeight/2+iHeight/4,iWidth/4,iHeight/4);
		Draw_Sphere_24();
