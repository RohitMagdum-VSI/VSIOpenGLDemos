...
{
	GLfloat height_to_width_ratio, width_to_height_ratio;
	if (height == 0)
		height = 1;
	...
	height_to_width_ratio = (GLfloat)height / (GLfloat)width;
	width_to_height_ratio = (GLfloat)width / (GLfloat)height;

	if (width <= height)
		glFrustum(-1.0f, 1.0f, -1.0f*height_to_width_ratio, 1.0f*height_to_width_ratio, 0.1f, 100.0f);
	else
		glFrustum(-1.0f,1.0f,-1.0f*width_to_height_ratio,1.0f*width_to_height_ratio, 0.1f, 100.0f);
}
