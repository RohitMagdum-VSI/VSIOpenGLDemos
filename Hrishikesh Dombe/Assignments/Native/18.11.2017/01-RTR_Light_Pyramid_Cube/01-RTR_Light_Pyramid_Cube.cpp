...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szClassName, TEXT("Lights On Pyramid and Cube"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, 100, 100, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
	if (hwnd == NULL)
	{
...
void display(void)
{
	...
	glRotatef(gAngle_Pyramid, 0.0f, 1.0f, 0.0f);
	...
	glRotatef(gAngle_Cube, 1.0f, 1.0f, 1.0f);
	glBegin(GL_QUADS);
	//Front Face
	glNormal3f(0.0f, 0.0f, 1.0f);
	glVertex3f(1.0f, 1.0f, 1.0f);
...
void update(void)
{
	gAngle_Cube = gAngle_Cube + 0.1f;
	if (gAngle_Cube >= 360.0f)
		gAngle_Cube = 0.0f;

	gAngle_Pyramid = gAngle_Pyramid + 0.1f;
