...
function Mesh()
{
    ...
    this.prepareToDraw=function()
    {
        ...
        gl.vertexAttribPointer(WebGLMacros.HAD_ATTRIBUTE_VERTEX,
                               3,
                               gl.FLOAT,
                               false,0,0);
        gl.enableVertexAttribArray(WebGLMacros.HAD_ATTRIBUTE_VERTEX);
        ...
        gl.bufferData(gl.ARRAY_BUFFER,
                      norms,
                      gl.STATIC_DRAW);
        gl.vertexAttribPointer(WebGLMacros.HAD_ATTRIBUTE_NORMAL,
                               3,
                               gl.FLOAT,
                               false,0,0);
        gl.enableVertexAttribArray(WebGLMacros.HAD_ATTRIBUTE_NORMAL);
        gl.bindBuffer(gl.ARRAY_BUFFER,null);
        ...
        gl.bufferData(gl.ARRAY_BUFFER,
                      texCoords,
                      gl.STATIC_DRAW);
        gl.vertexAttribPointer(WebGLMacros.HAD_ATTRIBUTE_TEXTURE0,
