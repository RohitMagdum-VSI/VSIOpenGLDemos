...
function draw()
{
    ...
    if(IsLKeyPressed == true)
    {
        ...
        {
            light_position_Blue[0] = Math.sin(gAngle) * 10.0;
            light_position_Blue[1] = Math.cos(gAngle) * 10.0;
            light_position_Blue[2] = -6.0;

            light_position_Red[0] = 0.0;
            light_position_Red[1] = Math.sin(gAngle) * 10.0;
            light_position_Red[2] = ((Math.cos(gAngle) * 10.0) - 6.0);

            light_position_Green[0] = Math.cos(gAngle) * 10.0;
            light_position_Green[1] = 0.0;
            light_position_Green[2] = ((Math.sin(gAngle) * 10.0) - 6.0);
        }
