...
ID3D11ShaderResourceView *gpID3D11ShaderResourceView_Texture_Square_Procedural = NULL;
...
HRESULT initialize(void)
{
	...
	HRESULT LoadD3DTextureProcedural(ID3D11ShaderResourceView**);
	...
	hr = LoadD3DTextureProcedural(&gpID3D11ShaderResourceView_Texture_Square_Procedural);
	if (FAILED(hr))
	{
		fopen_s(&gpFile, gszLogFileName, "a+");
		fprintf_s(gpFile, "LoadD3DTexture() Failed For Kundali.\n");
...
HRESULT LoadD3DTextureProcedural(ID3D11ShaderResourceView **ppID3D11ShaderResourceView)
{
	HRESULT hr;
	...
	hr = DirectX::CreateWICTextureFromFile(gpID3D11Device, gpID3D11DeviceContext, L"White.bmp", NULL, ppID3D11ShaderResourceView);
	if (FAILED(hr))
	{
		fopen_s(&gpFile, gszLogFileName, "a+");
		fprintf_s(gpFile, "DirectX::CreateWICTextureFromFile() Failed For Texture From File.\n");
...
void display(void)
{
	float texcoord_Square[12];

	if (giTweak_Smiley_Flag == 1)
	{
		texcoord_Square[0] = 1.0f;
		texcoord_Square[1] = 0.5f;
		texcoord_Square[2] = 0.5f;
		texcoord_Square[3] = 0.5f;
		texcoord_Square[4] = 1.0f;
		texcoord_Square[5] = 1.0f;
		texcoord_Square[6] = 1.0f;
		texcoord_Square[7] = 1.0f;
		texcoord_Square[8] = 0.5f;
		texcoord_Square[9] = 0.5f;
		texcoord_Square[10] = 0.5f;
		texcoord_Square[11] = 1.0f;
	}

	else if (giTweak_Smiley_Flag == 2)
	{
		texcoord_Square[0] = 1.0f;
		texcoord_Square[1] = 0.0f;
		texcoord_Square[2] = 0.0f;
		texcoord_Square[3] = 0.0f;
		texcoord_Square[4] = 1.0f;
		texcoord_Square[5] = 1.0f;
		texcoord_Square[6] = 1.0f;
		texcoord_Square[7] = 1.0f;
		texcoord_Square[8] = 0.0f;
		texcoord_Square[9] = 0.0f;
		texcoord_Square[10] = 0.0f;
		texcoord_Square[11] = 1.0f;
	}

	else if (giTweak_Smiley_Flag == 3)
	{
		texcoord_Square[0] = 2.0f;
		texcoord_Square[1] = 0.0f;
		texcoord_Square[2] = 0.0f;
		texcoord_Square[3] = 0.0f;
		texcoord_Square[4] = 2.0f;
		texcoord_Square[5] = 2.0f;
		texcoord_Square[6] = 2.0f;
		texcoord_Square[7] = 2.0f;
		texcoord_Square[8] = 0.0f;
		texcoord_Square[9] = 0.0f;
		texcoord_Square[10] = 0.0f;
		texcoord_Square[11] = 2.0f;
	}

	else if (giTweak_Smiley_Flag == 4)
	{
		texcoord_Square[0] = 0.5f;
		texcoord_Square[1] = 0.5f;
		texcoord_Square[2] = 0.5f;
		texcoord_Square[3] = 0.5f;
		texcoord_Square[4] = 0.5f;
		texcoord_Square[5] = 0.5f;
		texcoord_Square[6] = 0.5f;
		texcoord_Square[7] = 0.5f;
		texcoord_Square[8] = 0.5f;
		texcoord_Square[9] = 0.5f;
		texcoord_Square[10] = 0.5f;
		texcoord_Square[11] = 0.5f;
	}

	else if (giTweak_Smiley_Flag == 0)
	{
		texcoord_Square[0] = 1.0f;
		texcoord_Square[1] = 0.0f;
		texcoord_Square[2] = 0.0f;
	...
	if (giTweak_Smiley_Flag == 1 || giTweak_Smiley_Flag == 2 || giTweak_Smiley_Flag == 3 || giTweak_Smiley_Flag == 4)
		gpID3D11DeviceContext->PSSetShaderResources(0, 1, &gpID3D11ShaderResourceView_Texture_Square);
	else
		gpID3D11DeviceContext->PSSetShaderResources(0, 1, &gpID3D11ShaderResourceView_Texture_Square_Procedural);
