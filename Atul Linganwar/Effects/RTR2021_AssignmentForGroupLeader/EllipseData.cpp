...
#define SCALE_AXIS_MERCURY		2.0f
#define SCALE_AXIS_VENUS		3.0f
#define SCALE_AXIS_EARTH		4.0f
#define SCALE_AXIS_MARS			5.0f
#define SCALE_AXIS_JUPITER		6.0f
#define SCALE_AXIS_SATURN		7.2f
#define SCALE_AXIS_URANUS		8.4f
#define SCALE_AXIS_NEPTUNE		9.5f
#define SCALE_AXIS_PLUTO		10.4f
...
PELLIPTICAL_PATH InitializeEllipsePath(GLint iVerticesCount, GLfloat fSemiMajorAxis, GLfloat fSemiMinorAxis)
{
	...
	for (int i = 0; i < iVerticesCount + 1; i++)
	{
		...
		// Color
		pEllipsePath->EllipseData.pfColors[iColorIndex++] = 0.2f;
		pEllipsePath->EllipseData.pfColors[iColorIndex++] = 0.2f;
		pEllipsePath->EllipseData.pfColors[iColorIndex++] = 0.2f;
	}
