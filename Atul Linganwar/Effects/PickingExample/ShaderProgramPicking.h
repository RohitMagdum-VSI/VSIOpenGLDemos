...
private:
	...
	GLuint m_uiObjectIndexUniform;
	GLuint m_uiTextureSamplerUniform;

	GLuint m_uiTextureSmiley;
	...
	bool InitializeColorProgramPicking(void);
	void UnInitializeColorProgramPicking(void);
...
public:
	...
	GLuint GetObjectIndexUniform() { return m_uiObjectIndexUniform; }
	GLuint GetTextureKundali() { return m_uiTextureKundali; }
	GLuint GetTextureStone() { return m_uiTextureStone; }
	GLuint GetTextureSmiley() { return m_uiTextureSmiley; }
};