...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	WCHAR wszClassName[] = L"Color Triangle";
...
bool Initialize()
{
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(triangleVertices), (const void*)triangleVertices, GL_STATIC_DRAW);
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(triangleColor), (const void*)triangleColor, GL_STATIC_DRAW);
