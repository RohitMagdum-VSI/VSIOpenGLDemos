...
GLfloat gRotateAngleTriangle;
GLfloat gRotateAngleSquare;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	WCHAR wszClassName[] = L"2D Rotation";
...
void Display(void)
{
	...
	rotationMatrix = vmath::rotate(gRotateAngleTriangle, 0.0f, 1.0f, 0.0f);
	...
	rotationMatrix = vmath::rotate(gRotateAngleSquare, 1.0f, 0.0f, 0.0f);
...
void Update(void)
{
	gRotateAngleTriangle = gRotateAngleTriangle + 0.2f;
	if (gRotateAngleTriangle > 360.0f)
	{
		gRotateAngleTriangle = 0.0f;
	}

	gRotateAngleSquare = gRotateAngleSquare + 0.2f;
	if (gRotateAngleSquare > 360.0f)
	{
		gRotateAngleSquare = 0.0f;
	}
}
