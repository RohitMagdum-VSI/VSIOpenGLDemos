...
CSphere* pCSphereHalo = NULL;
GLfloat SunRadius = 3.75f;
GLfloat HaloRadius = 20.0f;
...
void InitializeOpenGL(void)
{
	...
	pCSphereHalo = new CSphere(HaloRadius, 32, 32, GL_TRUE);
...
void RenderScene(void)
{
	glm::vec3 SunPos = glm::vec3(0.0f, 20.0f, -100.0f);
	...
	pCSphereSun->DrawSphere(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f));

	glFrontFace(GL_CW);
	pCSphereHalo->DrawSphere(glm::vec4(0.2f, 0.2f, 0.2f, 1.0f));
	glFrontFace(GL_CCW);
