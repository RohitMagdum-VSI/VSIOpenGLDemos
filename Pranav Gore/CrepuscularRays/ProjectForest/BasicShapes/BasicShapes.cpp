...
void CBasicShapes::GenerateObjectVAO(GLuint VAO, GLuint EBO, GLboolean ColorOnlyMode)
{
...
void CBasicShapes::DrawObject(GLuint VAO, GLuint EBO, GLuint IndicesCount, glm::vec4 Color)
{
	glBindVertexArray(VAO);
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, EBO);
	glVertexAttrib4fv(OGL_ATTRIBUTE_COLOR, glm::value_ptr(Color));
	glDrawElements(GL_TRIANGLES, 3 * IndicesCount, GL_UNSIGNED_INT, 0);
	glBindVertexArray(0);
}
...
CRing::CRing(GLfloat InnerRadius, GLfloat OuterRadius, GLuint Slices, GLboolean ColorOnlyMode)
{
	...
	GenerateObjectVAO(m_VAORing, m_EBORing, ColorOnlyMode);
}
...
void CRing::DrawRing(glm::vec4 Color)
{
	glDisable(GL_CULL_FACE);
	DrawObject(m_VAORing, m_EBORing, m_RingIndicesCount, Color);
	glEnable(GL_CULL_FACE);
}
...
CSphere::CSphere(GLfloat Radius, GLuint Slices, GLuint Stacks, GLboolean ColorOnlyMode)
{
	...
	GenerateObjectVAO(m_VAOSphere, m_EBOSphere, ColorOnlyMode);
}
...
void CSphere::DrawSphere(glm::vec4 Color)
{
	DrawObject(m_VAOSphere, m_EBOSphere, m_SphereIndicesCount, Color);
}

///////////////////////////////////////////////////////////////
// Torus

CTorus::CTorus(GLfloat InnerRadius, GLfloat OuterRadius, GLint Slices, GLint Stacks, GLboolean ColorOnlyMode)
{
	this->m_InnerRadius = InnerRadius;
	this->m_OuterRadius = OuterRadius;
	this->m_Slices = Slices;
	...
	GenerateObjectVAO(m_VAOTorus, m_EBOTorus, ColorOnlyMode);
}
...
void CTorus::DrawTorus(glm::vec4 Color)
{
	DrawObject(m_VAOTorus, m_EBOTorus, m_TorusIndicesCount, Color);
}

///////////////////////////////////////////////////////////////////
// Cylinder

CCylinder::CCylinder(GLfloat Radius, GLfloat Height, GLuint Slices, GLboolean IsTop, GLboolean IsBottom, GLboolean ColorOnlyMode)
{
	this->m_Radius = Radius;
	...
	GenerateObjectVAO(m_VAOCylinder, m_EBOCylinder, ColorOnlyMode);
}
...
void CCylinder::DrawCylinder(glm::vec4 Color)
{
	DrawObject(m_VAOCylinder, m_EBOCylinder, m_CylinderIndicesCount, Color);
}

///////////////////////////////////////////////////////////////////////////////
// Cone

CCone::CCone(GLfloat Radius, GLfloat Height, GLuint Slices, GLboolean IsBottom, GLboolean ColorOnlyMode)
{
	this->m_Radius = Radius;
	this->m_Height = Height;
	this->m_Slices = Slices;
	...
	GenerateObjectVAO(m_VAOCone, m_EBOCone, ColorOnlyMode);
}
...
void CCone::DrawCone(glm::vec4 Color)
{
	DrawObject(m_VAOCone, m_EBOCone, m_ConeIndicesCount, Color);
}
