...
private:
	...
	std::vector<glm::vec3> TerrainTangentBuffer;
...
public:
	...
	void RenderTerrain(glm::mat4 ModelMatrix, glm::mat4 LightViewMatrix, glm::mat4 LightProjectionMatrix, GLuint ShaderProgramObject);
