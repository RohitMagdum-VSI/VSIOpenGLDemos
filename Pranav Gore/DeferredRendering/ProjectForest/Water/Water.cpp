...
{	
	...
	glUniform3f(glGetUniformLocation(ShaderProgramObjectWater, "fogColor"), 0.45f, 0.60f, 0.70f);
	glUniform1f(glGetUniformLocation(ShaderProgramObjectWater, "fogDencity"), 0.004f);
