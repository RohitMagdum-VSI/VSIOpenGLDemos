...
function main(){
	...
	canvas_RRJ = document.getElementById("27-SolarSystem-RRJ");
	if(!canvas_RRJ){
...
function initialize(){
	...
	myMakeSphere(1.0, STACK_RRJ, SLICES_RRJ);
...
function draw(){
	...
	gl_RRJ.useProgram(shaderProgramObject_RRJ);
		...
		mat4.translate(modelViewMatrix_RRJ, modelViewMatrix_RRJ, [0.0, 0.0, -5.0]);


		my_glPushMatrix(modelViewMatrix_RRJ);
		//console.log("Set1: " + modelViewMatrix_RRJ);
		...
		gl_RRJ.bindVertexArray(vao_Sphere_RRJ);
			...
			gl_RRJ.vertexAttrib3f(WebGLMacros.AMC_ATTRIBUTE_COLOR, 1.0, 1.0, 0.0);
			gl_RRJ.bindBuffer(gl_RRJ.ELEMENT_ARRAY_BUFFER, vbo_Sphere_Index_RRJ);
		...
		//console.log("set2: " + modelViewMatrix_RRJ);

		mat4.rotateY(modelViewMatrix_RRJ, modelViewMatrix_RRJ, degToRad(year_RRJ));
		mat4.translate(modelViewMatrix_RRJ, modelViewMatrix_RRJ, [3.0, 0.0, 0.0]);

		my_glPushMatrix(modelViewMatrix_RRJ);
		//console.log("set1: " + modelViewMatrix_RRJ);
		
		mat4.scale(modelViewMatrix_RRJ, modelViewMatrix_RRJ, [0.3, 0.3, 0.3]);
		mat4.rotateX(modelViewMatrix_RRJ, modelViewMatrix_RRJ, degToRad(90.0));
		mat4.rotateZ(modelViewMatrix_RRJ, modelViewMatrix_RRJ, degToRad(day_RRJ));
		...
		gl_RRJ.bindVertexArray(vao_Sphere_RRJ);
			...
			//gl_RRJ.drawArrays(gl_RRJ.POINTS, 0, 30*30);
			gl_RRJ.vertexAttrib3f(WebGLMacros.AMC_ATTRIBUTE_COLOR, 0.0, 0.0, 1.0);
			gl_RRJ.bindBuffer(gl_RRJ.ELEMENT_ARRAY_BUFFER, vbo_Sphere_Index_RRJ);
			gl_RRJ.drawElements(gl_RRJ.LINES, (STACK_RRJ) * (SLICES_RRJ) * 6, gl_RRJ.UNSIGNED_SHORT, 0);
...
function update(){
	...
	angle_Sphere_RRJ = angle_Sphere_RRJ + 0.7;
...
function my_glPushMatrix(matrix){
	...
	/*my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 0] = matrix[0];
	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 1] = matrix[1];
	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 2] = matrix[2];
	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 3] = matrix[3];

	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 4] = matrix[4];
	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 5] = matrix[5];
	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 6] = matrix[6];
	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 7] = matrix[7];

	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 8] = matrix[8];
	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 9] = matrix[9];
	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 10] = matrix[10];
	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 11] = matrix[11];

	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 12] = matrix[12];
	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 13] = matrix[13];
	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 14] = matrix[14];
	my_ModelViewStack_RRJ[(iTop_RRJ * 9) + 15] = matrix[15];*/
