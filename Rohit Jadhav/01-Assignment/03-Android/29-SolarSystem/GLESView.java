package com.rohit_r_jadhav.solar_system;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnDoubleTapListener, OnGestureListener{
	...
	private void uninitialize(){
		...
		if(vbo_Sphere_Color_RRJ[0] != 0){
			GLES32.glDeleteBuffers(1, vbo_Sphere_Color_RRJ, 0);
			vbo_Sphere_Color_RRJ[0] = 0;
		}
	...
	private void display(){
		...
		GLES32.glUseProgram(shaderProgramObject_RRJ);
			...
			for(int i = 0; i < 16; i++){
				System.out.println("RRJ: Set1 : " + modelViewMatrix_RRJ[i] + "\n");
			}
			...
			for(int i = 0; i < 16; i++){
				System.out.println("RRJ: Set2 : " + modelViewMatrix_RRJ[i] + "\n");
			}
