...
@implementation AppDelegate{
    @private
        ...
        ViewController *myViewController_RRJ;
...
-(BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions{
    ...
    myViewController_RRJ = [[ViewController alloc] init];

    [mainWindow_RRJ setRootViewController: myViewController_RRJ];

    glesView_RRJ = [[GLESView alloc] initWithFrame: screenBounds_RRJ];

    [myViewController_RRJ setView: glesView_RRJ];

    [glesView_RRJ release];

    [mainWindow_RRJ addSubview:[myViewController_RRJ view]];
