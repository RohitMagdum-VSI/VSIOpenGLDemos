...
void CreateWindow(void){
	...
	XStoreName(gpDisplay_RRJ, gWindow_RRJ, "18-PerVertexLighting");
	...
	if (iShaderCompileStatus_RRJ == GL_FALSE) {
		...
		if (iInfoLogLength_RRJ > 0) {
			...
			if (szInfoLog_RRJ != NULL) {
				GLsizei written;
				glGetShaderInfoLog(iVertexShaderObject_RRJ, iInfoLogLength_RRJ, &written, szInfoLog_RRJ);
...
void uninitialize(void) {
	...
	if (gShaderProgramObject_RRJ) {
		...
		if (pShader_RRJ) {
			glGetAttachedShaders(gShaderProgramObject_RRJ, ShaderCount_RRJ, &ShaderCount_RRJ, pShader_RRJ);
...
void display(void) {
	...
	if (bLights_RRJ == true) {
		...
		/*glUniform3f(La_Uniform_RRJ, 0.0f, 0.0f, 0.0f);
		glUniform3f(Ld_Uniform_RRJ, 1.0f, 1.0f, 1.0f);
		glUniform3f(Ls_Uniform_RRJ, 1.0f, 1.0f, 1.0f);
		glUniform4f(lightPositionUniform_RRJ, 100.0f, 100.0f, 100.0f, 1.0f);

		glUniform3f(Ka_Uniform_RRJ, 0.0f, 0.0f, 0.0f);
		glUniform3f(Kd_Uniform_RRJ, 1.0f, 1.0f, 1.0f);
		glUniform3f(Ks_Uniform_RRJ, 1.0f, 1.0f, 1.0f);
