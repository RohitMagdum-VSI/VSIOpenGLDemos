...
-(void)applicationDidFinishLaunching:(NSNotification*)aNotification{
    ...
    [window_RRJ setTitle: @"Rohit_R_Jadhav-Mac-12-Pyramid_Cube"];
    [window_RRJ center];
...
@implementation GLView_RRJ
{
    @private
        ...
        GLuint vbo_Pyramid_Color_RRJ;

        GLuint vao_Cube_RRJ;
        GLuint vbo_Cube_Position_RRJ;
        GLuint vbo_Cube_Color_RRJ;
...
-(void) prepareOpenGL {
    ...
    glBindVertexArray(vao_Pyramid_RRJ);
        ...
        /********** Color **********/
        glGenBuffers(1, &vbo_Pyramid_Color_RRJ);
        glBindBuffer(GL_ARRAY_BUFFER, vbo_Pyramid_Color_RRJ);
        glBufferData(GL_ARRAY_BUFFER, sizeof(pyramid_Color_RRJ), pyramid_Color_RRJ, GL_STATIC_DRAW);
	...
	glBindVertexArray(vao_Cube_RRJ);
        ...
        /********** Position *********/
        glGenBuffers(1, &vbo_Cube_Color_RRJ);
        glBindBuffer(GL_ARRAY_BUFFER, vbo_Cube_Color_RRJ);
        glBufferData(GL_ARRAY_BUFFER, sizeof(cube_Color_RRJ), cube_Color_RRJ, GL_STATIC_DRAW);
        glVertexAttribPointer(AMC_ATTRIBUTE_COLOR, 3, GL_FLOAT, GL_FALSE, 0, NULL);
        glEnableVertexAttribArray(AMC_ATTRIBUTE_COLOR);
        glBindBuffer(GL_ARRAY_BUFFER, 0);
...
-(void) dealloc {
    ...
    if(vbo_Cube_Color_RRJ){
        glDeleteBuffers(1, &vbo_Cube_Color_RRJ);
        vbo_Cube_Color_RRJ = 0;
    }
    ...
    if(vbo_Pyramid_Color_RRJ){
        glDeleteBuffers(1, &vbo_Pyramid_Color_RRJ);
        vbo_Pyramid_Color_RRJ = 0;
    }
