...
-(void)applicationDidFinishLaunching:(NSNotification*)aNotification{
    ...
    [window_RRJ setTitle: @"Rohit_R_Jadhav-Mac-06-Color-Tri-Rect"];
    [window_RRJ center];
...
-(void) prepareOpenGL {
	...
	glBindVertexArray(vao_Rect_RRJ);
        ...
        glBufferData(GL_ARRAY_BUFFER, sizeof(rectangle_Color_RRJ), rectangle_Color_RRJ, GL_STATIC_DRAW);
        glVertexAttribPointer(AMC_ATTRIBUTE_COLOR, 3, GL_FLOAT, GL_FALSE, 0, NULL);
        glEnableVertexAttribArray(AMC_ATTRIBUTE_COLOR);
        glBindBuffer(GL_ARRAY_BUFFER, 0);
...
-(void) drawView {
    ...
    translateMatrix_RRJ = vmath::translate(-2.0f, 0.0f, -6.0f);
    rotateMatrix_RRJ = vmath::rotate(0.0f, angle_Tri_RRJ, 0.0f);
    ...
    translateMatrix_RRJ = vmath::translate(2.0f, 0.0f, -6.0f);
    rotateMatrix_RRJ = vmath::rotate(angle_Rect_RRJ, 0.0f, 0.0f);
    modelViewMatrix_RRJ = modelViewMatrix_RRJ * translateMatrix_RRJ * rotateMatrix_RRJ;
    modelViewProjectionMatrix_RRJ = perspectiveProjectionMatrix_RRJ * modelViewMatrix_RRJ;
