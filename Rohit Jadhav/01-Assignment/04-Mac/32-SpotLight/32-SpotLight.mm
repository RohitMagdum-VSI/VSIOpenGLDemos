...
-(void)applicationDidFinishLaunching:(NSNotification*)aNotification{
    ...
    [window_RRJ setTitle: @"Rohit_R_Jadhav-Mac-32-SpotLight"];
    [window_RRJ center];
...
GLfloat spotLightCutoff_RRJ = cos(2 * PI / 180.0f);	//0.78539f
...
-(void) prepareOpenGL {
	...
	spotLightDirectionUniform_RRJ = glGetUniformLocation(shaderProgramObject_RRJ, "u_spotLightDirection");
	spotLightCutoffUniform_RRJ = glGetUniformLocation(shaderProgramObject_RRJ, "u_spotLightCutoff");
	spotLightExponentUniform_RRJ = glGetUniformLocation(shaderProgramObject_RRJ, "u_spotLightExponent");
	constantAttenuationUniform_RRJ = glGetUniformLocation(shaderProgramObject_RRJ, "u_constantAttenuation");
	linearAttenuationUniform_RRJ = glGetUniformLocation(shaderProgramObject_RRJ, "u_linearAttenuation");
	quadraticAttenuationUniform_RRJ = glGetUniformLocation(shaderProgramObject_RRJ, "u_quadraticAttenuation");
