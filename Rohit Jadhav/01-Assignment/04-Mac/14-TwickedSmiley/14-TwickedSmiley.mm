...
-(void)applicationDidFinishLaunching:(NSNotification*)aNotification{
    ...
    [window_RRJ setTitle: @"Rohit_R_Jadhav-Mac-14-TwickedSmiley"];
    [window_RRJ center];
...
-(void) drawView {
    ...
    if (iKeyPress_RRJ == 1) {
		rect_TexCoord_RRJ[0] = 0.5f;
		rect_TexCoord_RRJ[1] = 0.5f;

		rect_TexCoord_RRJ[2] = 1.0f;
		rect_TexCoord_RRJ[3] = 0.5f;

		rect_TexCoord_RRJ[4] = 1.0f;
		rect_TexCoord_RRJ[5] = 1.0f;

		rect_TexCoord_RRJ[6] = 0.5f;
		rect_TexCoord_RRJ[7] = 1.0f;
	}
	else if (iKeyPress_RRJ == 2) {
		rect_TexCoord_RRJ[0] = 0.0f;
		rect_TexCoord_RRJ[1] = 0.0f;

		rect_TexCoord_RRJ[2] = 1.0f;
		rect_TexCoord_RRJ[3] = 0.0f;

		rect_TexCoord_RRJ[4] = 1.0f;
		rect_TexCoord_RRJ[5] = 1.0f;

		rect_TexCoord_RRJ[6] = 0.0f;
		rect_TexCoord_RRJ[7] = 1.0f;
	}
	else if (iKeyPress_RRJ == 3) {
		rect_TexCoord_RRJ[0] = 0.0f;
		rect_TexCoord_RRJ[1] = 0.0f;

		rect_TexCoord_RRJ[2] = 2.0f;
		rect_TexCoord_RRJ[3] = 0.0f;

		rect_TexCoord_RRJ[4] = 2.0f;
		rect_TexCoord_RRJ[5] = 2.0f;

		rect_TexCoord_RRJ[6] = 0.0f;
		rect_TexCoord_RRJ[7] = 2.0f;
	}
	else if (iKeyPress_RRJ == 4) {
		rect_TexCoord_RRJ[0] = 0.5f;
		rect_TexCoord_RRJ[1] = 0.5f;

		rect_TexCoord_RRJ[2] = 0.5f;
		rect_TexCoord_RRJ[3] = 0.5f;

		rect_TexCoord_RRJ[4] = 0.5f;
		rect_TexCoord_RRJ[5] = 0.5f;

		rect_TexCoord_RRJ[6] = 0.5f;
		rect_TexCoord_RRJ[7] = 0.5f;
	}
    ...
    glBindVertexArray(vao_Rect_RRJ);
    	...
    	glBindBuffer(GL_ARRAY_BUFFER, vbo_Rect_Texcoord_RRJ);
    	glBufferData(GL_ARRAY_BUFFER, sizeof(rect_TexCoord_RRJ), rect_TexCoord_RRJ, GL_DYNAMIC_DRAW);
    	glBindBuffer(GL_ARRAY_BUFFER, 0);
