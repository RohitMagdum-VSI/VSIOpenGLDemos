...
ID3D11Buffer *gpID3D11Buffer_VertexBuffer_Pyramid_Color_RRJ = NULL;
float angle_Pyramid_RRJ = 360.0f;

//For Cube
ID3D11Buffer *gpID3D11Buffer_VertexBuffer_Cube_Position_RRJ = NULL;
ID3D11Buffer *gpID3D11Buffer_VertexBuffer_Cube_Color_RRJ = NULL;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow){
	...
	HWND hwnd_RRJ;
	MSG msg_RRJ;
	TCHAR szName_RRJ[] = TEXT("Rohit_R_Jadhav-D3D-13-Pyrami_RRJd-Cube");
	...
	hwnd_RRJ = CreateWindowEx(WS_EX_APPWINDOW,
		szName_RRJ,
		TEXT("Rohit_R_Jadhav-D3D-13-Pyrami_RRJd-Cube"),
		WS_OVERLAPPEDWINDOW,
		100, 100,
...
HRESULT initialize(void){
	...
	D3D11_BUFFER_DESC bufferDesc_VertexBuffer_Pyramid_Color_RRJ;
	ZeroMemory((void*)&bufferDesc_VertexBuffer_Pyramid_Color_RRJ, sizeof(D3D11_BUFFER_DESC));

	bufferDesc_VertexBuffer_Pyramid_Color_RRJ.Usage = D3D11_USAGE_DYNAMIC;
	bufferDesc_VertexBuffer_Pyramid_Color_RRJ.ByteWidth = sizeof(float) * _ARRAYSIZE(pyramid_Color);
	bufferDesc_VertexBuffer_Pyramid_Color_RRJ.BindFlags = D3D11_BIND_VERTEX_BUFFER;
	bufferDesc_VertexBuffer_Pyramid_Color_RRJ.CPUAccessFlags = D3D11_CPU_ACCESS_WRITE;

	 hr_RRJ = gpID3D11Device_RRJ->CreateBuffer(&bufferDesc_VertexBuffer_Pyramid_Color_RRJ, NULL,
	 	&gpID3D11Buffer_VertexBuffer_Pyramid_Color_RRJ);

	 if(FAILED(hr_RRJ)){
		fopen_s(&gbFile_RRJ, gszLogFileName, "a+");
		fprintf_s(gbFile_RRJ, "ERROR: Initialize-> Pyramid Color-> ID3D11Device::CreateBuffer()\n");
		fclose(gbFile_RRJ);
		return(hr_RRJ);
	} 
	else{
		fopen_s(&gbFile_RRJ, gszLogFileName, "a+");
		fprintf_s(gbFile_RRJ, "SUCCESS: Initialize-> Pyramid Color-> ID3D11Device::CreateBuffer()\n");
		fclose(gbFile_RRJ);
	}
	...
	D3D11_MAPPED_SUBRESOURCE mappedSubresource_Pyramid_Color_RRJ;
	ZeroMemory((void*)&mappedSubresource_Pyramid_Color_RRJ, sizeof(D3D11_MAPPED_SUBRESOURCE));

	gpID3D11DeviceContext_RRJ->Map(gpID3D11Buffer_VertexBuffer_Pyramid_Color_RRJ, 0,
		D3D11_MAP_WRITE_DISCARD, 0, &mappedSubresource_Pyramid_Color_RRJ);
	memcpy(mappedSubresource_Pyramid_Color_RRJ.pData, pyramid_Color, sizeof(pyramid_Color));
	gpID3D11DeviceContext_RRJ->Unmap(gpID3D11Buffer_VertexBuffer_Pyramid_Color_RRJ, 0);
	...
	/********** CUBE COLOR BUFFER **********/
	D3D11_BUFFER_DESC bufferDesc_VertexBuffer_Cube_Color_RRJ;
	ZeroMemory((void*)&bufferDesc_VertexBuffer_Cube_Color_RRJ, sizeof(D3D11_BUFFER_DESC));

	bufferDesc_VertexBuffer_Cube_Color_RRJ.Usage = D3D11_USAGE_DYNAMIC;
	bufferDesc_VertexBuffer_Cube_Color_RRJ.ByteWidth = sizeof(float) * _ARRAYSIZE(cube_Color);
	bufferDesc_VertexBuffer_Cube_Color_RRJ.BindFlags = D3D11_BIND_VERTEX_BUFFER;
	bufferDesc_VertexBuffer_Cube_Color_RRJ.CPUAccessFlags = D3D11_CPU_ACCESS_WRITE;

	hr_RRJ = gpID3D11Device_RRJ->CreateBuffer(&bufferDesc_VertexBuffer_Cube_Color_RRJ, NULL,
		&gpID3D11Buffer_VertexBuffer_Cube_Color_RRJ);

	if(FAILED(hr_RRJ)){
		fopen_s(&gbFile_RRJ, gszLogFileName, "a+");
		fprintf_s(gbFile_RRJ, "ERROR: Initialize-> Cube Color-> ID3D11Device::CreateBuffer()\n");
		fclose(gbFile_RRJ);
		return(hr_RRJ);
	} 
	else{
		fopen_s(&gbFile_RRJ, gszLogFileName, "a+");
		fprintf_s(gbFile_RRJ, "SUCCESS: Initialize-> Cube Color-> ID3D11Device::CreateBuffer()\n");
		fclose(gbFile_RRJ);
	}


	/********** CUBE COLOR MAPPING **********/
	D3D11_MAPPED_SUBRESOURCE mappedSubresource_Cube_Color_RRJ;
	ZeroMemory((void*)&mappedSubresource_Cube_Color_RRJ, sizeof(D3D11_MAPPED_SUBRESOURCE));

	gpID3D11DeviceContext_RRJ->Map(gpID3D11Buffer_VertexBuffer_Cube_Color_RRJ, 0,
		D3D11_MAP_WRITE_DISCARD, 0, &mappedSubresource_Cube_Color_RRJ);
	memcpy(mappedSubresource_Cube_Color_RRJ.pData, cube_Color, sizeof(cube_Color));
	gpID3D11DeviceContext_RRJ->Unmap(gpID3D11Buffer_VertexBuffer_Cube_Color_RRJ, 0);
...
void uninitialize(void){
	...
	if(gpID3D11Buffer_VertexBuffer_Cube_Color_RRJ){
		gpID3D11Buffer_VertexBuffer_Cube_Color_RRJ->Release();
		gpID3D11Buffer_VertexBuffer_Cube_Color_RRJ = NULL;
	}
	...
	if(gpID3D11Buffer_VertexBuffer_Pyramid_Color_RRJ){
		gpID3D11Buffer_VertexBuffer_Pyramid_Color_RRJ->Release();
		gpID3D11Buffer_VertexBuffer_Pyramid_Color_RRJ = NULL;
	}
...
void display(void){
	...
	offset = 0;
	gpID3D11DeviceContext_RRJ->IASetVertexBuffers(1, 1, &gpID3D11Buffer_VertexBuffer_Pyramid_Color_RRJ, &stride, &offset); 	
	...
	stride = sizeof(float) * 3;
	offset = 0;
	gpID3D11DeviceContext_RRJ->IASetVertexBuffers(1, 1, &gpID3D11Buffer_VertexBuffer_Cube_Color_RRJ, &stride, &offset);
	...
	gpID3D11DeviceContext_RRJ->Draw(4, 4);
	gpID3D11DeviceContext_RRJ->Draw(4, 8);
	gpID3D11DeviceContext_RRJ->Draw(4, 12);
	gpID3D11DeviceContext_RRJ->Draw(4, 16);
	gpID3D11DeviceContext_RRJ->Draw(4, 20);
