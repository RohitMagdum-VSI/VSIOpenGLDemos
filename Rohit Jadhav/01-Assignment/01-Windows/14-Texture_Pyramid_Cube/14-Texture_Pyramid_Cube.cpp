...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	HWND hwnd;
	MSG msg;
	TCHAR szName[] = TEXT("RohitRJadhav-PP-Textured_Pyramid_Cube");
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szName,
		TEXT("RohitRJadhav-PP-Textured_Pyramid_Cube"),
...
int initialize(void) {
	...
	texture_Pyramid = loadTexture(MAKEINTRESOURCE(ID_BITMAP_STONE));
	texture_Cube = loadTexture(MAKEINTRESOURCE(ID_BITMAP_KUNDALI));
...
void update(void) {
	...
	angle_Pyramid = angle_Pyramid + 0.8f;
	angle_Cube = angle_Cube - 0.8f;
