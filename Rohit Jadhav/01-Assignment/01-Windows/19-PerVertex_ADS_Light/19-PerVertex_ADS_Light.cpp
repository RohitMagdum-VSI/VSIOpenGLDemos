...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	HWND hwnd_RRJ;
	MSG msg_RRJ;
	TCHAR szName_RRJ[] = TEXT("RohitRJadhav-PP-PerVertex_Phong_ADS_Lights_OnSphere");
	...
	hwnd_RRJ = CreateWindowEx(WS_EX_APPWINDOW,
		szName_RRJ,
		TEXT("RohitRJadhav-PP-PerVertex_Phong_ADS_Lights_OnSphere"),
...
int initialize(void) {
	...
	materialShininess_RRJUniform_RRJ = glGetUniformLocation(gShaderProgramObject_RRJ, "u_shininess");
