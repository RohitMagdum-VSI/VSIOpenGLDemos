...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	HWND hwnd;
	MSG msg;
	TCHAR szName[] = TEXT("RohitRJadhav-PP-Color_Tri_Rect_Animation");
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szName,
		TEXT("RohitRJadhav-PP-Color_Tri_Rect_Animation"),
...
void update(void) {
	...
	angle_Tri = angle_Tri + 0.60f;
	angle_Rect = angle_Rect + 0.60f;
