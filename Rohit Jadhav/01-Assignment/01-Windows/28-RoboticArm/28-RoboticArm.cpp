...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	HWND hwnd_RRJ;
	MSG msg_RRJ;
	TCHAR szName_RRJ[] = TEXT("Rohit_R_Jadhav-RoboticArm");
	int iRet_RRJ;
	...
	hwnd_RRJ = CreateWindowEx(WS_EX_APPWINDOW,
		szName_RRJ,
		TEXT("Rohit_R_Jadhav-RoboticArm"),
...
void display(void) {
	...
	modelMatrix_RRJ = modelMatrix_RRJ * translate(0.0f, 0.0f, -12.0f);
	...
	modelViewMatrix_RRJ = modelViewMatrix_RRJ * rotate((GLfloat)shoulder_RRJ, 0.0f, 0.0f, 1.0f);
	modelViewMatrix_RRJ = modelViewMatrix_RRJ * translate(1.0f, 0.0f, 0.0f);

	my_glPushMatrix(modelViewMatrix_RRJ);

	modelViewMatrix_RRJ = modelViewMatrix_RRJ * scale(2.0f, 0.5f, 1.0f);
	...
	modelViewMatrix_RRJ = modelViewMatrix_RRJ * translate(1.0f, 0.0f, 0.0f);
	modelViewMatrix_RRJ = modelViewMatrix_RRJ * rotate((GLfloat)elbow_RRJ, 0.0f, 0.0f, 1.0f);
	modelViewMatrix_RRJ = modelViewMatrix_RRJ * translate(1.0f, 0.0f, 0.0f);
