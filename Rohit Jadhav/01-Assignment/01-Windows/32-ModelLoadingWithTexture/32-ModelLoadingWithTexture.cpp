...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	HWND hwnd_RRJ;
	MSG msg_RRJ;
	TCHAR szName_RRJ[] = TEXT("RohitRJadhav-PP-ModelLoadingWithTexture");
	...
	hwnd_RRJ = CreateWindowEx(WS_EX_APPWINDOW,
		szName_RRJ,
		TEXT("RohitRJadhav-PP-ModelLoadingWithTexture"),
...
int initialize(void) {
	...
	texture_Marble_RRJ = LoadTexture(MAKEINTRESOURCE(BITMAP_COTTAGE));
