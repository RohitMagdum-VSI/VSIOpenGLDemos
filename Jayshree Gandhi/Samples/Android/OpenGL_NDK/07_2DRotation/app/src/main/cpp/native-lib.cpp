...
Java_com_jayshree_ndkogltwodrotation_GLESNativeLib_resize(JNIEnv *env, jclass type, jint width, jint height)
{
    GLfloat aspectRatio;
...
extern "C" JNIEXPORT void JNICALL
Java_com_jayshree_ndkogltwodrotation_GLESNativeLib_init(JNIEnv *env, jclass type)
{
    printOpenGLESInfo();
...
extern "C" JNIEXPORT void JNICALL
Java_com_jayshree_ndkogltwodrotation_GLESNativeLib_display(JNIEnv *env, jclass type)
{
    //code
