...
#define	CLASS_NAME		TEXT("Rotate Triangle")
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		case '9':
			g_chChoice = wParam;
			resize(g_iCurrentWidth, g_iCurrentHeight);
			break;
...
{
	int iPerspectiveWidth = iWidth / 2;
	int iPerspectiveHeight = iHeight / 2;
	...
	//
	gluPerspective(45, (GLfloat)iPerspectiveWidth / (GLfloat)iPerspectiveHeight, 0.1f, 100.0f);
}
