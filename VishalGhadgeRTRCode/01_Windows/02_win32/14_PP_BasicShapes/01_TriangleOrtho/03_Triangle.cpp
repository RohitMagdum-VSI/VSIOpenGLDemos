...
#define	CLASS_NAME		TEXT("PP : Triangle")
...
mat4 g_matOrthoGraphicProjection;
...
VOID initialize()
{
	...
	g_matOrthoGraphicProjection = mat4::identity();
...
VOID resize(int iWidth, int iHeight)
{
	...
	if (iWidth <= iHeight)
	{
		g_matOrthoGraphicProjection = ortho(-100.0f, 100.0f, -100.0f * (iHeight/iWidth), 100.0f * (iHeight/iWidth), -100.0f, 100.0f);
	}
	else
	{
		g_matOrthoGraphicProjection = ortho(-100.0f, 100.0f, -100.0f * (iWidth/iHeight), 100.0f * (iWidth/iHeight), -100.0f, 100.0f);
	}
}
