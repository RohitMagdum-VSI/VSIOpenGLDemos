...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	WNDCLASSEX WndClass;
	bool boDone = false;
	TCHAR szClassName[] = TEXT("Horizantal Lines");
...
VOID display()
{
	...
	for (GLfloat glfHorizon = 0.05f; glfHorizon <= 1.0f; glfHorizon += 0.05f)
	{
		glBegin(GL_LINES);
		glVertex3f(-glfVertex, glfHorizon, 0.0f);
		glVertex3f(glfVertex, glfHorizon, 0.0f);
		glEnd();
