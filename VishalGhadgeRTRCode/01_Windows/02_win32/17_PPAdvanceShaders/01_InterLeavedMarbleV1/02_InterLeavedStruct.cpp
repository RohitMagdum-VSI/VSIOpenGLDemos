...
VOID initialize()
{
	...
	for (int i = 0; i < 24; i++)
	{
		...
		memcpy(&CubeVertices[i].position, (glfarrCubeVCNT + (0 + offset)), (3 * sizeof(float)));
		memcpy(&CubeVertices[i].color, (glfarrCubeVCNT + (3 + offset)), (3 * sizeof(float)));
		memcpy(&CubeVertices[i].normal, (glfarrCubeVCNT + (6 + offset)), (3 * sizeof(float)));
		memcpy(&CubeVertices[i].texture, (glfarrCubeVCNT + (9 + offset)), (2 * sizeof(float)));
	}
	////////////////////////////////////////////////////////////////////
	//+	Cube VAO
	...
	glVertexAttribPointer(RTR_ATTRIBUTE_POSITION, 3, GL_FLOAT, GL_FALSE, sizeof(CUBE_VERTEX), (void*)0);
	glEnableVertexAttribArray(RTR_ATTRIBUTE_POSITION);
	glVertexAttribPointer(RTR_ATTRIBUTE_COLOR, 3, GL_FLOAT, GL_FALSE, sizeof(CUBE_VERTEX), (void*)(3 * sizeof(float)));
	glEnableVertexAttribArray(RTR_ATTRIBUTE_COLOR);
	glVertexAttribPointer(RTR_ATTRIBUTE_NORMAL, 3, GL_FLOAT, GL_FALSE, sizeof(CUBE_VERTEX), (void*)(6 * sizeof(float)));
	glEnableVertexAttribArray(RTR_ATTRIBUTE_NORMAL);
	glVertexAttribPointer(RTR_ATTRIBUTE_TEXTURE0, 2, GL_FLOAT, GL_FALSE, sizeof(CUBE_VERTEX), (void*)(9 * sizeof(float)));
