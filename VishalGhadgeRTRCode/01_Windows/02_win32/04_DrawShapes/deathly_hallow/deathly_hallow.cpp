...
VOID DrawDeathlyHallows()
{
	...
	float fSide1, fSide2, fSide3, fTanget;
	float x1 = 0.0f, x2 = -0.5f, x3 = 0.5f, xMid;
	float y1 = 0.5f, y2 = -0.5f, y3 = -0.5f, yMid;
	...
	//
	fSide1 = sqrtf((powf((x2 - x1), 2.0f)) + (powf((y2 - y1), 2.0f)));
	fSide2 = sqrtf((powf((x3 - x2), 2.0f)) + (powf((y3 - y2), 2.0f)));
	fSide3 = sqrtf((powf((x3 - x1), 2.0f)) + (powf((y3 - y1), 2.0f)));

	xMid = (x2 + (fSide2 / 2.0f));
	//yMid = (y2 + (fSide2 / 2.0f));
	fTanget = sqrtf((powf((xMid - x1), 2.0f)) + (powf((yMid - y1), 2.0f)));

	//
	//	Semi perimeter of triangle s = (a + b + c) / 2
	//
	fSemiPerimeterofTriangle = (fSide1 + fSide2 + fSide3) / 2.0f;
	...
	fCenterX = (xMid + (fTanget / 2.0f));
	fCenterY = (yMid + (fTanget / 2.0f));
