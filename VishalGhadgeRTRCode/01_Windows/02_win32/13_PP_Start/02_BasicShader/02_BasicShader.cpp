...
#define	CLASS_NAME		TEXT("Basic Shader")

#define LOG_FILE_NAME	("log.txt")
//	Handle to log file
FILE *g_fpLogFile = NULL;

GLuint g_glui_VertexShaderObject;
GLuint g_glui_FragmentShaderObject;
GLuint g_glui_ShaderProgramObject;
...
VOID initialize()
{
	...
	//////////////////////////////////////////////////////////////////////
	//+	Vertex Shader 
	g_glui_VertexShaderObject = glCreateShader(GL_VERTEX_SHADER);
	...
	glShaderSource(g_glui_VertexShaderObject, 1, &szVertexShaderSourceCode, NULL);	//	NULL-in case of non-null terminated string provide length of string.

	//	Compile shader
	glCompileShader(g_glui_VertexShaderObject);
	//-	Vertex Shader 
	//////////////////////////////////////////////////////////////////////

	//////////////////////////////////////////////////////////////////////
	//+	Fragment Shader 
	g_glui_FragmentShaderObject = glCreateShader(GL_FRAGMENT_SHADER);
	...
	glShaderSource(g_glui_FragmentShaderObject, 1, &szFragmentShaderSourceCode, NULL);	//	NULL-in case of non-null terminated string provide length of string.

	//	Compile shader
	glCompileShader(g_glui_FragmentShaderObject);
	//-	Vertex Shader 
	//////////////////////////////////////////////////////////////////////
	...
	//	Create.
	g_glui_ShaderProgramObject = glCreateProgram();

	//	Attach vertex shader to shader program.
	glAttachShader(g_glui_ShaderProgramObject, g_glui_VertexShaderObject);

	//	Attach fragment shader to shader program.
	glAttachShader(g_glui_ShaderProgramObject, g_glui_FragmentShaderObject);

	//	Link shader
	glLinkProgram(g_glui_ShaderProgramObject);
...
VOID display()
{
	...
	glUseProgram(g_glui_ShaderProgramObject);
...
VOID uninitialize()
{
	...
	glDetachShader(g_glui_ShaderProgramObject, g_glui_VertexShaderObject);

	//	detach fragment shader from shader program object.
	glDetachShader(g_glui_ShaderProgramObject, g_glui_FragmentShaderObject);

	//	delete vertex shader object
	glDeleteShader(g_glui_VertexShaderObject);
	g_glui_VertexShaderObject = 0;

	//	delete fragment shader object
	glDeleteShader(g_glui_FragmentShaderObject);
	g_glui_FragmentShaderObject = 0;

	//	Delete shader program.
	glDeleteProgram(g_glui_ShaderProgramObject);
	g_glui_ShaderProgramObject = 0;

	//	Unlink shader program.
	glUseProgram(0);	//	Will get know later ? why this call is here?
