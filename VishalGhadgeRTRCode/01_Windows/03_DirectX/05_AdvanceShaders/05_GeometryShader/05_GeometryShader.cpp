...
#define WINDOW_NAME		L"D3D-Geometry Shader"
...
HRESULT initialize()
{
	...
	InputElementDesc.SemanticIndex = 0;	//	A semantic index is only needed in a case where there is more than one element with the same semantic.we will use in case of structure.
	InputElementDesc.Format = DXGI_FORMAT_R32G32B32_FLOAT;
	InputElementDesc.InputSlot = RTR_INPUT_SLOT_POSITION;//	An integer value that identifies the input-assembler (see input slot). Valid values are between 0 and 15, defined in D3D11.h.
