...
var g_TextureCheckerImage;

var checkImageWidth = 64;
var checkImageHeight = 64;
var checkImage = new Uint8Array(checkImageHeight * checkImageWidth);
...
function init()
{
	...
	g_TextureCheckerImage = gl.createTexture();
	makeCheckImage();
	gl.bindTexture(gl.TEXTURE_2D, g_TextureCheckerImage);
