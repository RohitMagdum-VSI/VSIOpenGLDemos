...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener,OnDoubleTapListener{
	...
	public void draw()
	{
		...
		//	bind with checker board texture.
		...
		///////////////////////////////////////////////////////////////////////
		//	+ Quad.
		float glfarrQuadVertices[] = new float[]
		{
		...
		//	Convert array to byte data.
		byBuffer = ByteBuffer.allocateDirect(glfarrQuadVertices.length * 4);
		byBuffer.order(ByteOrder.nativeOrder());
		fVerticesBuffer = byBuffer.asFloatBuffer();
		fVerticesBuffer.put(glfarrQuadVertices);
		fVerticesBuffer.position(0);
		
		GLES30.glBufferData(
							GLES30.GL_ARRAY_BUFFER,
							glfarrQuadVertices.length * 4,
							fVerticesBuffer,
							GLES30.GL_DYNAMIC_DRAW
							);
		GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER, 0);
		...
		///////////////////////////////////////////////////////////////////////
		//	+ Tilt quad.
		float glfarrQuadVerticesTild[] = new float[]
		{
			1.0f, -1.0f, 0.0f,
			1.0f, 1.0f, 0.0f,
		...
		//	Convert array to byte data.
		byBuffer = ByteBuffer.allocateDirect(glfarrQuadVerticesTild.length * 4);
		byBuffer.order(ByteOrder.nativeOrder());
		fVerticesBuffer = byBuffer.asFloatBuffer();
		fVerticesBuffer.put(glfarrQuadVerticesTild);
		fVerticesBuffer.position(0);
		
		GLES30.glBufferData(
							GLES30.GL_ARRAY_BUFFER,
							glfarrQuadVerticesTild.length * 4,
							fVerticesBuffer,
							GLES30.GL_DYNAMIC_DRAW
							);
		GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER, 0);
