...
@implementation GLESView
{
	...
	GLubyte g_arrCheckerImage[64][64][4];
}
...
-(void)LoadGLWhiteTextures
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, imageWidth, imageHeight, 0, GL_RGBA, GL_UNSIGNED_BYTE, g_arrCheckerImage);
