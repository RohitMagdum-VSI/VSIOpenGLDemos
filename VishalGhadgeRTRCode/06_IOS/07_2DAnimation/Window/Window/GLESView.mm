...
@implementation GLESView
{
	...
	GLfloat g_glfAngleTri;
	GLfloat g_glfAngleRect;
}
...
-(void)drawView:(id)sender
{
	...
	matModelView = matModelView * vmath::rotate(g_glfAngleTri, 0.0f, 1.0f, 0.0f);
	...
	matModelView = matModelView * vmath::rotate(g_glfAngleRect, 1.0f, 0.0f, 0.0f);
...
-(void)updateGL
{
	g_glfAngleTri = g_glfAngleTri + 0.5f;
	...
	g_glfAngleRect = g_glfAngleRect + 0.5f;
